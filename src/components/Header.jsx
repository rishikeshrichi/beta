...
function Header() {
  ...
  return (
    <Navbar bg="dark" variant="dark" expand="sm" style={{width:"100%"}}>
      <Container fluid>
        ...
        <Navbar.Toggle aria-controls="navbarScroll"  className='user'/>
  ...
  {user.displayName}
            ...
            <a class="codepen-button"  onClick={handleUpload}>
              <span >Upload</span>
            </a>
          </Nav>
        </Navbar.Collapse>
