  ...
  return (
    ...
    <div>
      ...
      />
        ...
        <Toast.Body>
          <FontAwesomeIcon style={{top:"100px"}} icon={faCheckCircle} /> Logged In
        </Toast.Body>
      </Toast>
{showErrorAlert && (
        <Alert variant="danger" onClose={() => setShowErrorAlert(false)} dismissible>
          <FontAwesomeIcon icon={faExclamationTriangle} /> Login failed. Please try again.
        </Alert>
      )}
          <a style={{ color: "black" }} href="#" onClick={reset}>
            Forgot Password?
          </a>
